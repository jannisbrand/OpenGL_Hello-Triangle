...
int main()
{
    ...
    // ***********************************SHADER****************************************
    Shader baseShader("../shaders/vertex_lighting_phong.vert", "../shaders/fragment_lighting_phong.frag");
    baseShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        baseShader.use();
        baseShader.setVec3("objectColor", glm::vec3(1.0f, 0.5f, 0.31f));
        baseShader.setVec3("lightColor", glm::vec3(1.0f, 1.0f, 1.0f));
        baseShader.setVec3("lightPosition", lightPos);    // Position of the light. (Cube in this example)
        ...
        float lightRotX = sin(glfwGetTime() / 2) * 2;
        float lightRotZ = cos(glfwGetTime() / 2) * 2;
        float lightMoveY = sin(glfwGetTime() / 2) * 2;

        std::cout << "\033[2J\033[H";
        std::cout << "ROTX: " << lightRotX << std::endl;
        std::cout << "ROTY: " << lightRotZ << std::endl;

        lightPos = glm::vec3(lightRotX, lightMoveY, lightRotZ);
