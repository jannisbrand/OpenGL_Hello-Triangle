...
int main()
{
    ...
    // ***********************************SHADER****************************************
    // Dont forget to change to the right shader you f**king idiot!
    Shader baseShader("../shaders/vertex_lighting_gouraud.vert", "../shaders/fragment_lighting_gouraud.frag");
    baseShader.use();
