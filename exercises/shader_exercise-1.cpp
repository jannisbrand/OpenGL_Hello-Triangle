...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "Shader exercise 1 - Rotation manipulation", 0, NULL);
    if (!window)
    {
    ...
    Shader myShaders("../shaders/vertex_exercise-1.vert", "../shaders/fragment.frag");
