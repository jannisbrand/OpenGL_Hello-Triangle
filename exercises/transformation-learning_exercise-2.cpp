...
int main()
{
    ...
    glm::mat4 translationMat1 = glm::mat4(1.0f);
    glm::mat4 translationMat2 = glm::mat4(1.0f);
    translationMat1 = glm::translate(translationMat1, glm::vec3(0.5f, -0.5f, 0.0f));
    translationMat2 = glm::translate(translationMat2, glm::vec3(-0.5f, 0.5f, 0.0f));
    // translationMat = glm::rotate(translationMat, glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)); 
    translationMat2 = glm::scale(translationMat2, glm::vec3(0.5f, 0.5f, 0.5f));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        translationMat1 = glm::mat4(1.0f);
        translationMat1 = glm::translate(translationMat1, glm::vec3(0.5f, -0.5f, 0.0f));
        translationMat1 = glm::rotate(translationMat1, glm::degrees((float)glfwGetTime() / 100), glm::vec3(0.0f, 0.0f, 1.0f));
        textureShader.use();
        glUniformMatrix4fv(glGetUniformLocation(textureShader.ID, "transform"), 1, GL_FALSE, glm::value_ptr(translationMat1));
        glDrawElements(GL_TRIANGLES, sizeof(indices), GL_UNSIGNED_INT, 0);

        float scale = sin(glfwGetTime()) / 4 + .25;
        translationMat2 = glm::mat4(1.0f);
        translationMat2 = glm::translate(translationMat2, glm::vec3(-0.5f, 0.5f, 0.0f));
        translationMat2 = glm::scale(translationMat2, glm::vec3(1.0f, 1.0f, 1.0f) * scale);
        textureShader.use();
        glUniformMatrix4fv(glGetUniformLocation(textureShader.ID, "transform"), 1, GL_FALSE, glm::value_ptr(translationMat2));
        glDrawElements(GL_TRIANGLES, sizeof(indices), GL_UNSIGNED_INT, 0);
