...
int main()
{
    ...
    Shader textureShader("../shaders/vertex_coordinate-system.vert", "../shaders/fragment_texture_exercise-1.frag");
    textureShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, glm::radians((float) glfwGetTime() / 500), glm::vec3(0.0f, 1.0f, 1.0f));
