...
int main()
{
    ...
    // ***********************************SHADER****************************************
    Shader baseShader("../shaders/vertex_lighting_phong_view-space.vert", "../shaders/fragment_lighting_phong_view-space.frag");
    baseShader.use();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec4 newLight = view * model * glm::vec4(lightPos, 1.0);   // Pre transform the light position into view space, if the shader calculations are also in views space. Avoids light shifting!
        baseShader.setVec3("lightPosition", glm::vec3(newLight.x, newLight.y, newLight.z));    //
