...
glm::vec3 lightPos(3.2f, 2.0f, 3.0f);
...
int main()
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*) 0);  // Vertex position (x,y,z)
    // --> No vertex color data in the base example! (1)
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*) (5* sizeof(float)));
    glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*) (3 * sizeof(float)));    // Texture coordinates (x,y)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 gamerLight;
        gamerLight.x = sin(glfwGetTime() * 2.0f) / 2 + 0.5f;
        gamerLight.y = sin(glfwGetTime() * 0.7f) / 2 + 0.5f;
        gamerLight.z = sin(glfwGetTime() * 1.3f) / 2 + 0.5f;
        ...
        baseShader.setVec3("light.ambient", gamerLight * glm::vec3(0.2f));
        baseShader.setVec3("light.diffuse", gamerLight * glm::vec3(0.5f));
        baseShader.setVec3("light.specular", gamerLight * glm::vec3(1.0f));
        baseShader.setVec3("material.ambient", glm::vec3(1.0f, 0.5f, 0.31f));
        baseShader.setVec3("material.diffuse", glm::vec3(1.0f, 0.5f, 0.31f));
        baseShader.setVec3("material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
        ...
        lightSourceShader.setVec3("objectColor", gamerLight);
