...
void main()
{
    ...
    vec3 viewDirection = normalize(vec3(0.0, 0.0, 0.0) - fragPosition);
    ...
    float specularShininess = pow(specularAngleDifference, 32); // The exponent defines how concentratet the reflection is.
